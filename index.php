...
<html lang="en">
	...
	<script type="text/javascript">
		...
		function getData(){
			$.ajax({
				...
				for (var i = 0; i <= result.length; i++) {
					var name = result[i]['prodPicture'];
					var substring = name.slice(3);

					document.getElementById('prodPic'+i).src = substring;
					document.getElementById('prodInfo'+i).innerHTML = result[i]['prodName'];
					document.getElementById('prod'+i).innerHTML = result[i]['prodPrice'];
		...
		$(document).ready(function(){
			...
			$('#btnForPass').click(function(){
				window.location.href = "C/forgetPass.php";
			});
		})
	</script>
	<style type="text/css">
	...
	<body>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-2 mb-4 mt-1" id="divCart">
						<a class="notification" data-toggle='modal' data-target='#loginModal'>
			...
			<div class="carousel-inner ml-4">
				<div class="carousel-item active">
					<div class="row mt-5 mb-5">
						<div class="products col-md-6 col-lg-4 col-xl-3">
							<img id="prodPic0"  width="80%" height="80%">
							<h6 id="prodInfo0" class="mt-3"></h6>
							<p id="prod0"></p>
						</div>
						<div class="products col-md-6 col-lg-4 col-xl-3">
							<img id="prodPic1"  width="80%" height="80%">
							<h6 id="prodInfo1" class="mt-3"></h6>
							<p id="prod1"></p>
						</div>
						<div class="products col-md-6 col-lg-4 col-xl-3">
							<img id="prodPic2"  width="80%" height="80%">
							<h6 id="prodInfo2" class="mt-3"></h6>
							<p id="prod2"></p>
						</div>
						<div class="products col-md-6 col-lg-4 col-xl-3">
							<img id="prodPic3"  width="80%" height="80%">
							<h6 id="prodInfo3" class="mt-3"></h6>
							<p id="prod3"></p>
						</div>
					</div>
				</div>
				<div class="carousel-item">
					<div class="row mt-5 mb-5">
						<div class="products col-md-6 col-lg-4 col-xl-3">
							<img id="prodPic4"  width="80%" height="80%">
							<h6 id="prodInfo4" class="mt-3"></h6>
							<p id="prod4"></p>
						</div>
						<div class="products col-md-6 col-lg-4 col-xl-3">
							<img id="prodPic5"  width="80%" height="80%">
							<h6  id="prodInfo5" class="mt-3"></h6>
							<p id="prod5"></p>
						</div>
						<div class="products col-md-6 col-lg-4 col-xl-3">
							<img id="prodPic6"  width="80%" height="80%">
							<h6 id="prodInfo6" class="mt-3"></h6>
							<p id="prod6"></p>
						</div>
						<div class="products col-md-6 col-lg-4 col-xl-3">
							<img id="prodPic7"  width="80%" height="80%">
							<h6 id="prodInfo7" class="mt-3"></h6>
							<p id="prod7"></p>
						</div>
					</div>
				</div>
		...
		<div class="container-fluid">
			...
			<div class="row mt-5 mb-5 ml-4">
				<div class="products col-md-6 col-lg-4 col-xl-3">
					<img id="prodPic8" width="80%" height="80%">
					<h6 id="prodInfo8" class="mt-3"></h6>
					<p id="prod8"></p>
				</div>
				<div class="products col-md-6 col-lg-4 col-xl-3">
					<img id="prodPic9" width="80%" height="80%">
					<h6 id="prodInfo9" class="mt-3"></h6>
					<p id="prod9"></p>
				</div>
				<div class="products col-md-6 col-lg-4 col-xl-3">
					<img id="prodPic10" width="80%" height="80%">
					<h6 id="prodInfo10" class="mt-3"></h6>
					<p id="prod10"></p>
				</div>
				<div class="products col-md-6 col-lg-4 col-xl-3">
					<img id="prodPic11" width="80%" height="80%">
					<h6 id="prodInfo11" class="mt-3"></h6>
					<p id="prod11"></p>
				</div>
			</div>
			<!---Login--->
