...
<head>
	...
	<script type="text/javascript">
		...
		function getProd(prodID){
			...
			window.location.href = "indiProds.php?p="+id+"&u?"+;
		};
		function getDataOne(){
			$.ajax({
				method: "GET",
...
<body>
	...
	<div class="container-fluid p-5">
		<div class="container-fluid p-5" id="food">
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4 col-xl-3" id="foodOne">
					
				</div>
				<div class="col-md-6 col-lg-4 col-xl-3" id="foodTwo">
					
				</div>
				<div class="col-md-6 col-lg-4 col-xl-3" id="foodThree">
